...
<section id="filtersection">
							...
							<h6>Home&nbsp; /&nbsp;<span>Women's Shoes</span></h6>
...
<section id="subcat">
						...
						<?php 			
			$query="select * from womenshoescat"; 			
			...
			while ($row=mysqli_fetch_array($run)) 			 
				{ 				
					...
					<h1><a href='womenscateg.php?wsid=$wsid'>$wstitle</a></h1>
...
<section id="cat_img">
	<div class="subimage">
		...
		<div class="grid-container">
			...
			$query="select * from images where wsid='$wsid'"; 			
			$run= mysqli_query($conn,$query); 			
			while ($row=mysqli_fetch_array($run)) 			 
				{ 				
					$id=$row['id']; 				
			...
			$query="select * from images where wshid='$wshid'"; 			
			$run= mysqli_query($conn,$query); 			
			while ($row=mysqli_fetch_array($run)) 			 
				{ 				
					$id=$row['id']; 				
		...
		<div class="squares">
			...
			while ($row=mysqli_fetch_array($run)) 			 
				{ 				
					...
					$wshsize=$row['wshsize'];  				
					echo" 			
					<a href='womenscateg.php?wshid=$wshid'>
					<div class='icon1'>
        			 <p>$wshsize</p>
      				</div></a>				
					"; 			

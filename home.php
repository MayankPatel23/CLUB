...
<div id="nsection">
		<div class="grid-container">
			<?php 			
			$query="select * from images order by rand() limit 8"; 			
			...
			while ($row=mysqli_fetch_array($run)) 			 
				...
				<header class="widget__header">
           			 <h3 class="widget__title2"><a href="women.php">Women's Clothing</a></h3>
       			 </header>
		<div class="bags">
				<div id="nsection1">
		<div class="grid-container">
		...
		<header class="widget__header">
           			 <h3 class="widget__title1"><a href="men.php">Men's Clothing</a></h3>
       			 </header>
		<div class="shoes">
				<div id="nsection2">
		<div class="grid-container">
			<?php 			
			$query="select * from images where type='mc'"; 			
			$run= mysqli_query($conn,$query); 			
			while ($row=mysqli_fetch_array($run)) 			 
				{ 				
					$id=$row['id']; 				
...
<header class="widget__header">
           			 <h3 class="widget__title3"><a href="womens.php">Women's Shoes</a></h3>
       			 </header>
		<div class="bags">
				<div id="nsection3">
		<div class="grid-container">
			<?php 			
			$query="select * from images where type='wshoes'"; 			
			$run= mysqli_query($conn,$query); 			
			while ($row=mysqli_fetch_array($run)) 			 
				{ 				
					$id=$row['id']; 				
...
<header class="widget__header">
           		 <h3 class="widget__title4"><a href="mens.php">Men's Shoes</h3></a>
       			 </header>
		<div class="bags">
				<div id="nsection4">
		<div class="grid-container">
			<?php 			
			$query="select * from images where type='shoes'"; 			
			$run= mysqli_query($conn,$query); 			
			while ($row=mysqli_fetch_array($run)) 			 
				{ 				
					$id=$row['id']; 				
